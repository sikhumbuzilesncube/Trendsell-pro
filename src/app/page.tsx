        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            <div className="flex flex-col items-center">
              <div className="w-12 h-12 bg-[#C9A44C] rounded-full flex items-center justify-center mb-3">
                <svg className="w-6 h-6 text-[#0B3D2E]" fill="currentColor" viewBox="0 0 20 20">
                  ...
                  <path d="M3 4a1 1 0 00-1 1v10a1 1 0 001 1h1.05a2.5 2.5 0 014.9 0H10a1 1 0 001-1V5a1 1 0 00-1-1H3zM14 7h1.05a2.5 2.5 0 014.9 0H19a1 1 0 011 1v8a1 1 0 01-1 1h-1.05a2.5 0 01-4.9 0H13a1 1 0 01-1-1V7z" />
                </svg>
              </div>
            ...
            <div className="flex flex-col items-center">
              <div className="w-12 h-12 bg-[#C9A44C] rounded-full flex items-center justify-center mb-3">
                <svg className="w-6 h-6 text-[#0B3D2E]" fill="currentColor" viewBox="0 0 20 20">
                  <path d="M8.433 7.418c.155-.103.346-.196.567-.267v1.698a2.305 0 01-.567-.267C8.07 8.34 8 8.114 8 8c0-.114.07-.34.433-.582zM11 12.849v-1.698c.22.071.412.164.567.267.364.243.433.468.433.582 0 .114-.07.34-.433.582a2.305 2.305 0 01-.567.267z" />
